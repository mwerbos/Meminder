...
--type TimeData = (Day, x)
-- How to put typeclass constraint into a data declaration?
-- Want x to be Num and Show
--instance GnuplotIdiom (TimeData) where
